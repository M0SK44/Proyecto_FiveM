...
import GestionVehiculos from './gestion_vehiculos'; // Asegúrate de que este archivo exista
...
root.render(
    <Router>
        <Routes>
            ...
            <Route path="/gestion_vehiculos" element={<GestionVehiculos />} /> {/* Ruta para la gestión de usuarios */}
